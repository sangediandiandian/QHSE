...
const emergencyResources: EmergencyResource[] = [
  ...
  { id: 'res-003', code: 'MED-AED-01', name: '急救担架与 AED', type: '医疗', quantity: '2 组', totalQuantity: 2, availableQuantity: 2, unit: '组', location: '厂区医务室', eta: '6 分钟', status: '待命', owner: '林晓', contact: '6120', lastInspection: '2026-06-26', nextInspection: '2026-07-18', inspectionStatus: '即将到期', batches: [{ id: 'batch-003-01', batchNo: 'AED-202601', quantity: 2, availableQuantity: 2, receivedAt: '2026-01-15', expiryDate: '2026-08-05' }], dispatches: [], inspectionRecords: [] },
  ...
  { id: 'res-006', code: 'GAS-MOBILE-02', name: '移动式气体检测组', type: '气防', quantity: '6 台', totalQuantity: 6, availableQuantity: 6, unit: '台', location: '中央控制室', eta: '4 分钟', status: '待命', owner: '刘洋', contact: '6218', lastInspection: '2026-07-09', nextInspection: '2026-08-09', inspectionStatus: '检查合格', batches: [{ id: 'batch-006-01', batchNo: 'GAS-202512', quantity: 2, availableQuantity: 2, receivedAt: '2025-12-20', expiryDate: '2026-07-10' }, { id: 'batch-006-02', batchNo: 'GAS-202606', quantity: 4, availableQuantity: 4, receivedAt: '2026-06-30', expiryDate: '2027-06-30' }], dispatches: [], inspectionRecords: [] },
  ...
  { id: 'res-008', code: 'BOOM-ABS-01', name: '围油栏与吸附材料', type: '物资', quantity: '3 套', totalQuantity: 3, availableQuantity: 3, unit: '套', location: '储运应急库', eta: '10 分钟', status: '待命', owner: '周敏', contact: '6077', lastInspection: '2026-06-30', nextInspection: '2026-07-30', inspectionStatus: '检查合格', batches: [{ id: 'batch-008-01', batchNo: 'ABS-202605-A', quantity: 1, availableQuantity: 1, receivedAt: '2026-05-15', expiryDate: '2026-07-25' }, { id: 'batch-008-02', batchNo: 'ABS-202607-B', quantity: 2, availableQuantity: 2, receivedAt: '2026-07-01', expiryDate: '2027-07-01' }], dispatches: [], inspectionRecords: [] },
];
