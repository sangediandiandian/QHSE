...
export const roles: Role[] = [
  { id: 'role-leader', code: 'enterprise_leader', name: '企业领导', permissions: ['risk:read', 'hazard:read', 'permit:read', 'permit:approve', 'warning:read', 'emergency:read', 'plan:read', 'resource:read', 'communication:read', 'telemetry:read', 'attachment:read', 'report:read', 'report:export', 'config:read', 'monitor:read'], dataScope: 'all' },
  { id: 'role-qhse', code: 'qhse_manager', name: 'QHSE 管理人员', permissions: ['risk:read', 'risk:assess', 'risk:controls:update', 'hazard:read', 'hazard:report', 'hazard:rectify', 'hazard:accept', 'hazard:supervise', 'permit:read', 'permit:apply', 'permit:approve', 'permit:control', 'warning:read', 'warning:edit', 'warning:submit', 'warning:approve', 'warning:toggle', 'warning:evaluate', 'warning:handle', 'warning:close', 'emergency:read', 'emergency:manage', 'emergency:evidence', 'emergency:approve', 'plan:read', 'plan:edit', 'plan:submit', 'plan:approve', 'plan:drill', 'resource:read', 'resource:manage', 'resource:dispatch', 'resource:inspect', 'communication:read', 'communication:send', 'communication:confirm', 'telemetry:read', 'telemetry:ingest', 'attachment:read', 'attachment:upload', 'report:read', 'report:export', 'config:read', 'monitor:read', 'audit:read'], dataScope: 'all' },
  { id: 'role-dispatcher', code: 'production_dispatcher', name: '生产调度人员', permissions: ['risk:read', 'hazard:read', 'hazard:report', 'permit:read', 'permit:apply', 'permit:approve', 'permit:control', 'warning:read', 'warning:approve', 'warning:evaluate', 'warning:handle', 'warning:close', 'emergency:read', 'emergency:manage', 'emergency:evidence', 'plan:read', 'plan:approve', 'plan:drill', 'resource:read', 'resource:dispatch', 'resource:inspect', 'communication:read', 'communication:send', 'communication:confirm', 'telemetry:read', 'telemetry:ingest', 'attachment:read', 'attachment:upload', 'report:read'], dataScope: 'all' },
  { id: 'role-unit-manager', code: 'unit_manager', name: '装置负责人', permissions: ['risk:read', 'risk:assess', 'risk:controls:update', 'hazard:read', 'hazard:report', 'hazard:rectify', 'permit:read', 'permit:apply', 'permit:approve', 'permit:confirm', 'permit:control', 'warning:read', 'warning:handle', 'warning:close', 'emergency:read', 'emergency:manage', 'emergency:evidence', 'plan:read', 'plan:drill', 'resource:read', 'resource:inspect', 'communication:read', 'communication:confirm', 'telemetry:read', 'attachment:read', 'attachment:upload', 'report:read'], dataScope: 'assigned_areas' },
  { id: 'role-operator', code: 'operator', name: '岗位操作人员', permissions: ['risk:read', 'hazard:read', 'hazard:report', 'hazard:rectify', 'permit:read', 'permit:apply', 'permit:confirm', 'warning:read', 'warning:handle', 'emergency:read', 'emergency:evidence', 'resource:read', 'communication:read', 'communication:confirm', 'telemetry:read', 'attachment:read', 'attachment:upload'], dataScope: 'assigned_areas' },
  { id: 'role-environment', code: 'environment_manager', name: '环保管理人员', permissions: ['risk:read', 'hazard:read', 'hazard:report', 'hazard:rectify', 'permit:read', 'permit:apply', 'permit:approve', 'permit:confirm', 'warning:read', 'warning:handle', 'warning:close', 'emergency:read', 'emergency:manage', 'emergency:evidence', 'resource:read', 'resource:inspect', 'communication:read', 'communication:confirm', 'telemetry:read', 'telemetry:ingest', 'attachment:read', 'attachment:upload', 'report:read'], dataScope: 'assigned_areas' },
  { id: 'role-emergency', code: 'emergency_commander', name: '应急指挥人员', permissions: ['risk:read', 'hazard:read', 'permit:read', 'warning:read', 'warning:handle', 'warning:close', 'emergency:read', 'emergency:manage', 'emergency:evidence', 'plan:read', 'plan:drill', 'resource:read', 'resource:dispatch', 'resource:inspect', 'communication:read', 'communication:send', 'communication:confirm', 'telemetry:read', 'attachment:read', 'attachment:upload', 'report:read'], dataScope: 'all' },
  { id: 'role-admin', code: 'system_admin', name: '系统管理员', permissions: ['risk:read', 'risk:assess', 'risk:controls:update', 'hazard:read', 'hazard:report', 'hazard:rectify', 'hazard:accept', 'hazard:supervise', 'permit:read', 'permit:apply', 'permit:approve', 'permit:confirm', 'permit:control', 'warning:read', 'warning:edit', 'warning:submit', 'warning:approve', 'warning:toggle', 'warning:evaluate', 'warning:handle', 'warning:close', 'emergency:read', 'emergency:manage', 'emergency:evidence', 'emergency:approve', 'plan:read', 'plan:edit', 'plan:submit', 'plan:approve', 'plan:drill', 'resource:read', 'resource:manage', 'resource:dispatch', 'resource:inspect', 'communication:read', 'communication:send', 'communication:confirm', 'telemetry:read', 'telemetry:ingest', 'attachment:read', 'attachment:upload', 'report:read', 'report:export', 'config:read', 'config:manage', 'monitor:read', 'iam:read', 'iam:manage', 'audit:read'], dataScope: 'all' },
];
